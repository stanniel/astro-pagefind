...
declare module "*/pagefind.js" {
  ...
  export type PagefindQueryTermIdf = {
  ...
  export type PagefindPreloadFn = (
    term: string,
    options?: PagefindSearchOptions,
  ) => Promise<void>;

  /** Retrieve all available filter values and counts */
  export type PagefindFiltersFn = () => Promise<PagefindFilterCounts>;
  ...
  export type PagefindInstance = {
    ...
    options: PagefindOptionsFn;
    /** Wait for this instance to finish initializing (WASM load, etc.) */
    init: PagefindInitFn;
    /** Destroy this instance and terminate its worker */
    destroy: PagefindDestroyFn;
    /** Merge an additional index into this instance */
    mergeIndex: PagefindMergeIndexFn;
    /** Search this instance's index */
    search: PagefindSearchFn;
    /** Debounced search — returns null if superseded by a newer call */
    debouncedSearch: PagefindDebounceSearchFn;
    /** Preload index chunks for a search term without returning results */
    preload: PagefindPreloadFn;
    /** Retrieve all available filter values and counts */
    filters: PagefindFiltersFn;
  };
   ...
   * All instances share a single web worker and WASM module internally.
   */
  export type PagefindCreateInstanceFn = (
    instanceOptions?: PagefindIndexOptions,
  ) => PagefindInstance;

  /** Update options for the main instance */
  export const options: PagefindOptionsFn;

  /** Wait for the main instance to finish initializing (WASM load, etc.) */
  export const init: PagefindInitFn;

  /** Destroy the main instance and terminate its worker */
  export const destroy: PagefindDestroyFn;

  /** Merge an additional index into the main instance */
  export const mergeIndex: PagefindMergeIndexFn;

  /** Search the main instance's index */
  export const search: PagefindSearchFn;

  /** Debounced search — returns null if superseded by a newer call */
  export const debouncedSearch: PagefindDebounceSearchFn;

  /** Preload index chunks for a search term without returning results */
  export const preload: PagefindPreloadFn;

  /** Retrieve all available filter values and counts */
  export const filters: PagefindFiltersFn;
   ...
   * All instances share a single web worker and WASM module internally.
   */
  export const createInstance: PagefindCreateInstanceFn;
}
